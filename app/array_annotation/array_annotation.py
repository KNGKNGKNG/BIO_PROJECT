...
def array_annotation(array_file):
    ...
    print('connect_dbsnp')
    connect_dbsnp_sql = open('./python/array_annotation/connect_dbsnp.sql').read()
    ...
    print('connect_gwas')
    connect_gwas_sql = open('./python/array_annotation/connect_gwas.sql').read()
    ...
    print('connect_1kgp')
    connect_1kgp_sql = open('./python/array_annotation/connect_1kgp.sql').read()
    ...
    connect_uniprot_sql = open('./python/array_annotation/connect_uniprot.sql').read()
